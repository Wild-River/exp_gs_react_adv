      ...
      <div className="mt-10 grid grid-cols-1 gap-10 lg:grid-cols-12">
        ...
        <aside className="space-y-5 lg:sticky lg:top-8 lg:col-span-5 lg:self-start">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="hover:bg-teal-500-600 rounded border border-teal-500 bg-white px-4 py-2 font-bold text-teal-500 hover:bg-teal-500 hover:text-white"
            >
              クリア
            </button>
          </div>
        ...
        <section className="min-h-96 rounded-xl lg:col-span-7">
          {!feedback ? (
            ...
            <div className="border-8 border-teal-600/30 px-10 py-10 text-lg leading-10 whitespace-pre-wrap">
              <ReactMarkdown
                components={{
